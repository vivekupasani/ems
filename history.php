...
<body class="bg-gray-100">
            ...
            <div class="overflow-x-auto">
                <table id="employeeTable" class="min-w-full bg-white border rounded-lg">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                HRA</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Medical Allowance</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Travelling Allowance</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Other Allowance</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200" id="employeeTableBody">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="40" class="px-6 py-4 text-center text-sm text-gray-500">No deleted employees
                                    found in history.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
    ...
    <script>
        ...
        function exportToExcel() {
            ...
            // Customize the file name with a timestamp
            const fileName = `History_Employees_${new Date().toISOString().slice(0, 10)}.xlsx`;

            // Write the file and trigger download
            XLSX.writeFile(wb, fileName);
        }

        // Optional: Add basic client-side filtering (example for search)
