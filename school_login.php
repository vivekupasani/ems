...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full">
        ...
        <div class="text-center mb-8">
            <i class="fas fa-school text-6xl text-green-600"></i>
            <h2 class="mt-4 text-3xl font-bold text-gray-900">School Login</h2>
            <p class="mt-2 text-gray-600">Access your school dashboard</p>
        </div>

        <div class="bg-white py-8 px-6 shadow-2xl rounded-lg">
            <form action="school_process.php" method="POST" class="space-y-6">
                <div>
        ...
        <div class="mt-4 text-center">
            <a href="default.php" class="text-sm text-gray-600 hover:text-green-500">
