    ...
    <div class="max-w-7xl mx-auto px-4">
      <div class="flex justify-between items-center h-auto py-4 md:h-20">
        ...
        <div class="flex items-center">
          <button class="bg-red-500 hover:bg-red-600 text-white px-3 py-1.5 md:px-4 md:py-2 rounded-md flex items-center text-sm md:text-base" onClick="window.location='default.php'">
