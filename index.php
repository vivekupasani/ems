...
// Set a timestamp for the last activity
...
window.onload = function() {
    ...
    //   // Check if the user is navigating back or forward
    ...
    //       window.location.href = 'admin_login.php'; // Fallback to login
    //     });
    // });

    // // Push initial state to history to detect navigation
